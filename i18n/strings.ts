...
export const STRINGS: Record<SupportedLocale, Bundle> = {
  en: {
    ...
    'home.timeLimit.minutesShort': 'min',
  ...
  ru: {
    ...
    'home.timeLimit.minutesShort': 'мин',
  ...
  fr: {
    'splash.tagline': 'Aiguise ton esprit',
    'language.title': 'Choisis ta langue',
    'language.subtitle': 'Tu pourras la changer plus tard dans les réglages',

    'onboarding.skip': 'Passer',
    'onboarding.next': 'Suivant',
    'onboarding.start': 'Commencer',
    'onboarding.page1.title': 'Aiguise ton esprit',
    'onboarding.page1.subtitle':
      'Découvre de nouveaux faits et teste tes connaissances dans les thèmes que tu aimes.',
    'onboarding.page2.title': 'Choisis tes thèmes',
    'onboarding.page2.subtitle':
      'Géographie, histoire, sciences, arts, sport — joue à ce qui te plaît vraiment.',
    'onboarding.page3.title': 'Suis ta progression',
    'onboarding.page3.subtitle':
      'Gagne des points, garde ta série et grimpe dans le classement.',
    ...
    'settings.section.share': 'Fais passer le mot',
    'settings.darkMode': 'Mode sombre',
    'settings.restorePurchases': 'Restaurer les achats',
    'settings.subscriptionManagement': 'Gérer l’abonnement',
    'settings.contactUs': 'Nous contacter',
    'settings.recommend': 'Recommander à un ami',
    'settings.rateUs': 'Nous noter',
    'settings.privacyPolicy': 'Politique de confidentialité',
    'settings.termsOfUse': 'Conditions d’utilisation',
    'settings.recommend.text': 'Je joue à Quizzes — jette un œil !',
    'settings.restorePurchases.titleAlert': 'Aucun achat à restaurer',
    'settings.restorePurchases.messageAlert': 'Les achats intégrés ne sont pas encore connectés dans cette version.',
    'settings.restorePurchases.dismiss': 'OK',
    'settings.signIn': 'Se connecter',
    'settings.signIn.titleAlert': 'La connexion arrive bientôt',
    'settings.signIn.messageAlert': 'Les comptes seront facultatifs — garde ta progression sur tous tes appareils une fois connecté.',
    'settings.languageModal.title': 'Choisis la langue',
    'settings.appearance': 'Apparence',
    'settings.appearanceModal.title': 'Apparence',
    'settings.theme.light': 'Clair',
    'settings.theme.dark': 'Sombre',
    'settings.version': 'Version',
    'common.cancel': 'Annuler',

    'lives.outOf.title': 'Plus de vies',
    'lives.outOf.body': 'Les vies se rechargent chaque jour, ou tu peux en obtenir tout de suite.',
    'lives.outOf.watchAd': 'Voir une pub pour +1 vie',
    'lives.outOf.watching': 'Chargement de la pub…',
    'lives.outOf.buy': 'Acheter des vies',
    'lives.outOf.later': 'Peut-être plus tard',
    'ads.failed.title': 'Aucune récompense',
    'ads.failed.body': 'La pub n’a pas été terminée, donc aucune vie n’a été ajoutée. Réessaie.',
    'buyLives.title': 'Obtiens plus de vies',
    'buyLives.subtitle': 'Recharge et continue à jouer',
    'account.title': 'Compte',
    'account.premiumBadge': 'Premium actif',
    'account.tab.signup': 'S’inscrire',
    'account.tab.login': 'Se connecter',
    'account.email': 'E-mail',
    'account.password': 'Mot de passe',
    'account.signup.cta': 'Créer un compte',
    'account.login.cta': 'Se connecter',
    'account.or': 'ou',
    'account.apple': 'Continuer avec Apple',
    'account.google': 'Continuer avec Google',
    'account.signup.hint': 'Déjà un compte ? Connecte-toi',
    'account.login.hint': 'Pas de compte ? Inscris-toi',
    'account.soon.title': 'Presque prêt',
    'account.soon.body': 'Les comptes ne sont pas encore connectés dans cette version — bientôt.',
    'lives.claim.title': 'Bonus quotidien',
    'lives.claim.body': 'Reviens demain pour 10 de plus.',
    'lives.claim.cta': 'Récupérer 10 vies',
    'lives.claim.claiming': 'Récupération…',
    'lives.claim.later': 'Passer pour l’instant',
    'lives.info.title': 'Comment obtenir plus de vies',
    'lives.info.dismiss': 'Compris',
    'lives.info.daily.title': '+{n} chaque jour',
    'lives.info.daily.subtitle': 'Ouvre l’appli une fois par jour et appuie sur Récupérer. Un jour manqué est perdu.',
    'lives.info.ad.title': 'Regarde une courte pub',
    'lives.info.ad.subtitle': 'Chaque vidéo récompensée donne +1 vie.',
    'lives.info.buy.title': 'Achète un pack',
    'lives.info.buy.subtitle': 'Les packs de vies en boutique vont de 10 à 100.',

    'hintsInfo.title': 'Tes indices',
    'hintsInfo.dismiss': 'Compris',
    'hintsInfo.balanceSection': 'Ce qu’il te reste',
    'hintsInfo.sourcesSection': 'Comment en obtenir plus',
    'hintsInfo.fiftyFifty.title': '50/50',
    'hintsInfo.fiftyFifty.subtitle': 'Retire deux mauvaises réponses, laisse une bonne et une mauvaise',
    'hintsInfo.statistics.title': 'Stats des joueurs',
    'hintsInfo.statistics.subtitle': 'Montre à quelle fréquence les autres joueurs choisissent chaque option',
    'hintsInfo.replaceQuestion.title': 'Remplacer la question',
    'hintsInfo.replaceQuestion.subtitle': 'Propose une nouvelle question du même thème',
    'hintsInfo.source.ad.title': 'Regarde une courte pub',
    'hintsInfo.source.ad.subtitle': 'Chaque vidéo récompensée donne un indice.',
    'hintsInfo.source.buy.title': 'Achète un pack',
    'hintsInfo.source.buy.subtitle': 'Les packs d’indices en boutique contiennent de 5 à 20 de chaque type.',
    'hint.fiftyFifty': '50/50',
    'hint.statistics': 'Stats',
    'hint.replaceQuestion': 'Changer',
    'hint.replaceQuestion.unavailable': 'Aucune autre question à proposer pour le moment.',
    'shareQuestion.helper': 'Partager cette question',
    'shareQuestion.footer': '📱 Play Quizzzes - Sharpen your Mind — {url}',

    'shop.title': 'Boutique',
    'shop.balance.lives': 'Vies',
    'shop.balance.hints': 'Indices',
    'shop.section.freeLives': 'Vies gratuites',
    'shop.section.lives': 'Packs de vies',
    'shop.section.hints': 'Packs d’indices',
    'shop.section.combo': 'Packs combo',
    'shop.freeLives.title': 'Regarde une courte vidéo',
    'shop.freeLives.subtitle': '+1 vie — une fois par pause pub.',
    'shop.freeLives.cta': 'Regarder',
    'shop.freeLives.watching': 'Chargement…',
    'shop.thanks.title': 'Merci !',
    'shop.thanks.body': 'Ton achat a été ajouté.',
    'shop.error.title': 'Échec de l’achat',
    'shop.error.body': 'Réessaie.',
    'shop.lives.small.title': '10 vies',
    'shop.lives.small.subtitle': 'Une courte partie',
    'shop.lives.medium.title': '30 vies',
    'shop.lives.medium.subtitle': 'Un week-end de quiz',
    'shop.lives.large.title': '100 vies',
    'shop.lives.large.subtitle': 'Meilleur rapport',
    'shop.hints.small.title': '5 de chaque',
    'shop.hints.small.subtitle': '15 indices sur 3 types',
    'shop.hints.medium.title': '10 de chaque',
    'shop.hints.medium.subtitle': '30 indices sur 3 types',
    'shop.hints.large.title': '20 de chaque',
    'shop.hints.large.subtitle': '60 indices sur 3 types',
    'shop.combo.small.title': '10 vies + 5 indices',
    'shop.combo.small.subtitle': '10 vies et 5 de chaque indice',
    'shop.combo.medium.title': '30 vies + 10 indices',
    'shop.combo.medium.subtitle': '30 vies et 10 de chaque indice',
    'shop.combo.large.title': '100 vies + 20 indices',
    'shop.combo.large.subtitle': '100 vies et 20 de chaque indice',

    'home.tile.soon': 'Bientôt',
    'home.tile.meta': '{questions} questions · {topics} thèmes',
    'home.tile.coming.title': 'Plus de catégories',
    'home.tile.coming.meta': 'Bientôt',
    'home.error.load': 'Impossible de charger les catégories',
    'home.tabs.categories': 'Catégories',
    'home.tabs.modes': 'Modes',
    'home.mode.random10.title': '10 questions au hasard',
    'home.mode.random10.subtitle': 'Un mélange rapide de tous les thèmes',
    'home.mode.byTopic.title': 'Quiz par thème',
    'home.mode.byTopic.subtitle': 'Choisis une catégorie sur laquelle te concentrer',
    'home.mode.timed.title': 'Quiz chronométré',
    'home.mode.timed.subtitle': 'Bats le chrono à chaque question',
    'home.mode.challenge.title': 'Défi',
    'home.mode.challenge.subtitle': 'Tout ou rien',
    'home.mode.survival.title': 'Mode survie',
    'home.mode.survival.subtitle': 'Une erreur et c’est fini',
    'home.mode.mistakes.title': 'Erreurs',
    'home.mode.mistakes.subtitle': 'Rejoue les questions ratées',
    'home.mode.hard.title': 'Quiz difficile',
    'home.mode.hard.subtitle': 'Rien que les plus corsées',
    'home.mode.flashcards.title': 'Cartes',
    'home.mode.flashcards.subtitle': 'Parcours pour apprendre, sans score',
    'home.mode.today.title': 'Question du jour',
    'home.mode.today.subtitle': 'Une seule question au hasard',
    'home.mode.timeLimit.title': 'Limite de temps',
    'home.mode.timeLimit.subtitle': 'C’est le temps total qui compte',
    'home.mode.mistakes.empty': 'Pas encore d’erreurs',
    'home.timeLimit.subtitle': 'Choisis la durée de tout le quiz',
    'home.timeLimit.minutesShort': 'min',
    'home.config.start': 'Lancer le quiz',
    'home.config.byTopic.title': 'Quiz par thème',
    'home.config.timed.title': 'Quiz chronométré',
    'home.config.flashcards.title': 'Cartes',

    'stats.title': 'Stats du quiz',
    'stats.empty.title': 'Pas encore de stats',
    'stats.empty.subtitle': 'Termine un quiz pour commencer à suivre ta progression',
    'stats.totalActivity': 'Activité totale',
    'stats.quizzesTaken': 'Quiz joués',
    'stats.totalTime': 'Temps de quiz',
    'stats.timePerQuestion': 'Temps par question',
    'stats.accuracy': 'Précision',
    'stats.correct': 'Correctes',
    'stats.mistakes': 'Erreurs',
    'stats.viewedBySubject': 'Questions vues par thème',
    'stats.performanceBySubject': 'Performance par thème',
    'stats.headerSubject': 'Thème',
    'stats.headerViewed': 'Vues',
    'stats.headerTotal': 'Total',
    'stats.totalRow': 'Total',

    'achievements.title': 'Succès',
    'achievements.level': 'NIVEAU {n}',
    'achievements.maxLevel': 'MAX',
    'achievements.locked': 'Verrouillé',
    'achievements.unlocked.title': 'Succès débloqué',
    'achievements.unlocked.cta': 'Génial',
    'achievements.activity.title': 'Champion du quiz',
    'achievements.activity.subtitle': 'Termine des quiz',
    'achievements.knowledge.title': 'Soif de savoir',
    'achievements.knowledge.subtitle': 'Réponds à des questions',
    'achievements.accuracy.title': 'Tireur d’élite',
    'achievements.accuracy.subtitle': 'Obtiens des réponses correctes',
    'achievements.time.title': 'Érudit du temps',
    'achievements.time.subtitle': 'Temps passé à apprendre',
    'achievements.explorer.title': 'Explorateur',
    'achievements.explorer.subtitle': 'Aborde différents thèmes',
    'achievements.mistakes.title': 'Apprendre de ses erreurs',
    'achievements.mistakes.subtitle': 'Erreurs enregistrées',
    'achievements.perfect.title': 'Parcours parfait',
    'achievements.perfect.subtitle': 'Quiz terminés sans la moindre erreur',
    'achievements.unlocked.share': 'Partager',
    'achievements.share.text': 'Je viens de débloquer « {title} » — Niveau {level} sur Quizzes !',

    'home.hard.modalTitle': 'Quiz difficile',
    'home.hard.modalSubtitle': 'Choisis comment saisir les réponses',
    'home.hard.typing.title': 'Taper la réponse',
    'home.hard.typing.subtitle': 'Tape chaque lettre toi-même',
    'home.hard.letters.title': 'Assembler à partir de lettres',
    'home.hard.letters.subtitle': 'Touche les bonnes lettres dans l’ordre',
    'hard.typing.placeholder': 'Tape ta réponse…',
    'hard.typing.lengthHint': 'Indice : {n} caractères',
    'hard.letters.assemble': 'Assemble le mot à partir des lettres',
    'hard.letters.available': 'Lettres disponibles',
    'hard.check': 'Vérifier',

    'quiz.loading': 'Chargement des questions...',
    'quiz.error.title': 'Une erreur est survenue',
    'quiz.error.retry': 'Réessayer',
    'quiz.error.home': 'Accueil',
    'quiz.next': 'Suivant',
    'quiz.results': 'Voir les résultats',

    'results.title': 'Quiz terminé !',
    'results.scoreLabel': '{score} sur {total}',
    'results.playAgain': 'Rejouer',
    'results.home': 'Accueil',
    'results.messageExcellent': 'Excellent ! Un véritable érudit !',
    'results.messageGood': 'Bien joué ! Continue d’apprendre.',
    'results.messageKeepGoing': 'Continue à t’entraîner, tu vas y arriver !',

    'report.title': 'Signaler un problème',
    'report.subtitle': 'Qu’est-ce qui ne va pas avec cet élément ?',
    'report.commentPlaceholder': 'Ajoute des détails (facultatif)',
    'report.cancel': 'Annuler',
    'report.submit': 'Envoyer le signalement',
    'report.done': 'Terminé',
    'report.successTitle': 'Merci pour le signalement',
    'report.successBody': 'Nous allons l’examiner et corriger le contenu.',
    'report.helper': 'Signaler un problème avec cette question',
    'report.error': 'Impossible d’envoyer le signalement',
    'report.reason.incorrect_answer': 'Réponse incorrecte',
    'report.reason.unclear_wording': 'Peu clair ou mal formulé',
    'report.reason.inappropriate': 'Contenu inapproprié',
    'report.reason.broken_media': 'L’image ou le son ne se charge pas',
    'report.reason.translation_issue': 'Problème de traduction',
    'report.reason.other': 'Autre',

    'paywall.title': 'Quizzzes Premium',
    'paywall.subtitle': 'Débloque l’expérience complète',
    'paywall.feature.unlimited': 'Quiz illimités chaque jour',
    'paywall.feature.adfree': 'Sans pub, sans distraction',
    'paywall.feature.alllanguages': 'Toutes les langues et tous les thèmes',
    'paywall.feature.exclusive': 'Catégories exclusives réservées au Premium',
    'paywall.cta': 'Continuer',
    'paywall.tier.weekly': 'Hebdo',
    'paywall.tier.monthly': 'Mensuel',
    'paywall.tier.yearly': 'Annuel',
    'paywall.price.perWeek': '/sem',
    'paywall.price.perMonth': '/mois',
    'paywall.price.perYear': '/an',
    'paywall.badge.bestValue': 'Meilleur choix',
    'paywall.badge.save': 'Économise {percent} %',
    'paywall.continueFree': 'Peut-être plus tard',
    'paywall.disclaimer': 'Résiliable à tout moment dans les réglages de l’App Store.',
    'paywall.thanks': 'Bienvenue dans Premium 🎉',
    'paywall.col.free': 'Gratuit',
    'paywall.col.premium': 'Premium',
    'paywall.row.lives': 'Vies par jour',
    'paywall.row.lives.free': '10',
    'paywall.row.lives.premium': '20',
    'paywall.row.ad': 'Voir une pub',
    'paywall.row.ad.free': '+1 vie',
    'paywall.row.ad.premium': '+2 vies',
    'paywall.row.modes': 'Modes de quiz',
    'paywall.row.flashcards': 'Cartes',
    'paywall.row.stats': 'Stats',
    'paywall.row.stats.free': 'Basiques',
    'paywall.row.stats.premium': 'Avancées',
    'paywall.reviewAccess': 'Accès testeur — débloque pour tester le premium',
    'paywall.review.title': 'Accès testeur',
    'paywall.review.subtitle': 'Saisis les identifiants indiqués dans les instructions de test pour débloquer le premium.',
    'paywall.review.login': 'Identifiant',
    'paywall.review.password': 'Mot de passe',
    'paywall.review.submit': 'Débloquer',
    'paywall.review.cancel': 'Annuler',
    'paywall.review.invalid': 'Identifiant ou mot de passe non valide.',
    'paywall.review.networkError': 'Erreur de connexion. Réessaie.',
    'paywall.restore': 'Restaurer les achats',
    'paywall.restore.none.title': 'Rien à restaurer',
    'paywall.restore.none.body': 'Aucun abonnement Premium actif n’a été trouvé pour ce compte.',
    'paywall.error.title': 'Échec de l’achat',
    'paywall.error.body': 'Une erreur est survenue. Réessaie.',

    'mode.title': 'Choisis un mode',
    'mode.daily.title': 'Question du jour',
    'mode.daily.subtitle': 'Une seule question pour rester affûté',
    'mode.random.title': 'Question aléatoire',
    'mode.random.subtitle': 'Une question au hasard de cette catégorie',
    'mode.quick.title': 'Quiz rapide',
    'mode.quick.subtitle': '10 questions, sans limite de temps',
    'mode.timed.title': 'Quiz chronométré',
    'mode.timed.subtitle': '30 secondes par question',
    'mode.timed.questionsLabel': 'Questions',
    'mode.timed.startCta': 'Commencer',
    'mode.survival.title': 'Survie',
    'mode.survival.subtitle': 'Une erreur et la partie est finie',
    'mode.flashcards.title': 'Cartes',
    'mode.flashcards.subtitle': 'Parcours les cartes pour réviser à ton rythme',
    'mode.lockedSoon': 'Bientôt',

    'quiz.timeUp': 'Temps écoulé !',
    'quiz.survival.streak': 'Série',
    'quiz.survival.over': 'Partie terminée à la question {n}',
  },
};
