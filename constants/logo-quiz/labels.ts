...
const FR: LQLabels = {
  ...
  level: 'Niveau {n}',
  finishPrevious: 'Termine 9 logos du niveau précédent',
  ...
  premiumPerks: 'Premium débloque',
  perkCategories: 'Débloque tous les logos premium',
  perkLives: 'Régénération des vies ×3',
  perkCoins: '2× pièces par bonne réponse',
  ...
  whichBrand: 'Quelle est cette marque ?',
  skip: 'Passer',
  review: 'Révision',
  prevLogo: 'Précédent',
  nextLogo: 'Suivant',
  ...
  reportSubtitle: 'Dis-nous ce qui ne va pas avec cette question.',
  reasonIncorrectAnswer: 'Réponse incorrecte',
  reasonUnclearWording: 'Peu claire ou confuse',
  reasonInappropriate: 'Contenu inapproprié',
  reasonBrokenMedia: 'L’image ne se charge pas',
  reasonTranslationIssue: 'Problème de traduction',
  reasonOther: 'Autre',
  reportCommentPlaceholder: 'Ajoute un commentaire (facultatif)',
  reportSubmit: 'Envoyer',
  reportCancel: 'Annuler',
  reportSentTitle: 'Merci !',
  reportSentBody: 'Ton signalement a été envoyé.',
  reportError: 'Envoi impossible. Réessaie.',
  reportDone: 'Terminé',
  shareInvite: 'Sauras-tu deviner ce logo ? Joue à Logo Quiz : {url}',
  roundOver: 'Manche terminée !',
  gameOver: 'Partie terminée',
  score: 'Score',
  explanations: 'Histoire',
  coinsEarned: 'Pièces gagnées',
  doubleCoinsUpsell: 'Gagne 2× plus de pièces avec Premium !',
  playAgain: 'Rejouer',
  next: 'Suivant',
  ...
  restoreDoneMessage: 'Ton abonnement premium est de nouveau actif.',
  ...
  wheelPrizeLives3: '3 vies',
  wheelPrizeCoins500: '500 pièces',
  wheelPrizeLives10: '10 vies',
  wheelPrizeCoins1000: '1000 pièces',
};

const TABLE: Record<string, LQLabels> = { en: EN, ru: RU, es: ES, fr: FR };
