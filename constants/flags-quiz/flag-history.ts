...
export const FLAG_HISTORY: Record<string, Record<SupportedLocale, string>> = {
  nigeria: {
    ...
    fr: 'Le Nigeria a adopté son drapeau vert-blanc-vert en 1960, lors de son indépendance. Les bandes vertes représentent les forêts et les terres agricoles, tandis que le blanc symbolise la paix. Le dessin est l’œuvre d’un étudiant de 23 ans, Taiwo Akinkunmi, vainqueur d’un concours national.',
  },
  gabon: {
    ...
    fr: 'Le Gabon a adopté son drapeau en 1960, après son indépendance de la France. Le vert représente ses vastes forêts tropicales, le bleu le littoral atlantique et la bande dorée centrale le soleil de l’équateur, qui traverse le pays. Ses trois bandes horizontales égales sont rares parmi les tricolores.',
  },
  mali: {
    ...
    fr: 'Le Mali a adopté son drapeau en 1961 aux couleurs panafricaines : le vert pour la terre fertile, l’or pour la pureté et les richesses, et le rouge pour le sang versé pour l’indépendance. Une première version portait une figure humaine, retirée par respect de la tradition islamique.',
  },
  guinea: {
    ...
    fr: 'La Guinée a adopté son drapeau en 1958, lors de son indépendance de la France. Le rouge honore le sacrifice du peuple, le jaune évoque le soleil et l’or du sous-sol, et le vert la végétation. Les couleurs reprennent celles du Ghana, reflétant l’idéal panafricain de l’époque.',
  },
  'ivory-coast': {
    ...
    fr: 'La Côte d’Ivoire a adopté son drapeau en 1959, à la veille de l’indépendance. L’orange représente les savanes du nord et la générosité de la terre, le blanc la paix et le vert les forêts du sud. Il ressemble au drapeau italien, mais avec l’ordre des couleurs inversé.',
  },
  chad: {
    ...
    fr: 'Le Tchad a adopté son drapeau en 1959 : le bleu pour le ciel et l’espoir, le jaune pour le soleil et le Sahara, et le rouge pour l’unité et le sacrifice. Il est presque identique à celui de la Roumanie, une coïncidence qui a suscité plusieurs débats diplomatiques sur son usage.',
  },
  mexico: {
    ...
    fr: 'Le drapeau actuel du Mexique a été adopté en 1968. Le vert symbolise l’espoir, le blanc l’unité et le rouge le sang des héros. Au centre, un aigle dévore un serpent sur un cactus : le présage aztèque qui indiqua où fonder Tenochtitlan, l’actuelle Mexico.',
  },
  canada: {
    ...
    fr: 'Le drapeau canadien à la feuille d’érable a été adopté en 1965, remplaçant les symboles britanniques. Les bandes rouges représentent les océans de part et d’autre du pays et le centre blanc ses étendues enneigées. La feuille à onze pointes fut choisie après des essais en soufflerie pour rester la plus nette au vent.',
  },
  honduras: {
    ...
    fr: 'Le Honduras a adopté son drapeau en 1866. Les deux bandes bleues représentent les océans Pacifique et Atlantique, et la bande blanche la paix. Les cinq étoiles bleues du centre symbolisent les nations de l’ancienne Fédération d’Amérique centrale et le rêve de les réunir un jour.',
  },
  guatemala: {
    ...
    fr: 'Le Guatemala a adopté son drapeau en 1871. Les bandes bleues représentent ses deux océans et le ciel, et le blanc la paix. Ses armoiries arborent le quetzal, symbole de liberté qui, dit-on, meurt en captivité, au-dessus d’un parchemin portant la date de l’indépendance de l’Amérique centrale.',
  },
  'costa-rica': {
    ...
    fr: 'Le Costa Rica a adopté son drapeau en 1848. Les bandes bleues et blanches évoquent l’ancienne Fédération d’Amérique centrale, tandis que la bande rouge, inspirée de la Révolution française, symbolise la chaleur du peuple et le sang versé pour la liberté. La bande rouge est deux fois plus large que les autres.',
  },
  nicaragua: {
    ...
    fr: 'Le Nicaragua a adopté son drapeau en 1908. Les bandes bleues représentent ses deux océans et le blanc la paix. Son emblème central montre un triangle d’égalité, cinq volcans pour les états unis et un arc-en-ciel d’espoir, ce qui en fait l’un des rares drapeaux nationaux à comporter du violet.',
  },
  bolivia: {
    ...
    fr: 'La Bolivie a adopté son drapeau en 1851. Le rouge honore le sang des héros, le jaune la richesse minière et le vert la fertilité de la terre. La Bolivie est l’un des rares pays à posséder deux drapeaux officiels : à côté de celui-ci flotte la Wiphala, l’étendard à damier des peuples andins.',
  },
  peru: {
    ...
    fr: 'Le Pérou a adopté son drapeau en 1825. La légende veut que le rouge et le blanc soient nés de flamants roses que le libérateur José de San Martín vit s’envoler, leurs ailes lançant du rouge et du blanc. Le rouge symbolise la lutte pour la liberté et le blanc la paix et la dignité nationale.',
  },
  colombia: {
    ...
    fr: 'La Colombie a adopté son drapeau en 1861. La large bande jaune représente l’or et les richesses du pays, la bleue ses mers et ses fleuves, et la rouge le sang versé pour l’indépendance. La bande jaune occupe la moitié du drapeau, soulignant l’abondance de la nation.',
  },
  venezuela: {
    ...
    fr: 'Le drapeau actuel du Venezuela a été adopté en 2006, avec l’ajout d’une huitième étoile comme le souhaitait Simón Bolívar. Le jaune représente les richesses de la terre, le bleu la mer qui le sépare de l’Espagne et le rouge le courage. Les huit étoiles symbolisent les provinces qui se soulevèrent pour l’indépendance.',
  },
  argentina: {
    ...
    fr: 'L’Argentine a adopté son drapeau en 1812 et y a ajouté le soleil en 1818. La légende raconte que le bleu ciel et le blanc évoquent le ciel apparu entre les nuages le jour du premier soulèvement. Le Soleil de Mai doré du centre est un ancien symbole inca marquant l’aube de la liberté.',
  },
  indonesia: {
    ...
    fr: 'L’Indonésie a adopté son drapeau en 1945, le jour où elle proclama son indépendance. La bande rouge représente le courage et le sang, et la blanche la pureté de l’esprit. Il est presque identique à celui de Monaco, quoique de proportions différentes, et c’est l’inverse exact de celui de la Pologne.',
  },
  armenia: {
    ...
    fr: 'L’Arménie a adopté son drapeau en 1990 lors de son indépendance, ressuscitant le tricolore de sa première république. Le rouge représente le sang et la lutte du peuple, le bleu le ciel paisible et l’orange le labeur et les terres fertiles. Les couleurs plongent leurs racines dans d’anciennes traditions arméniennes.',
  },
  india: {
    ...
    fr: 'L’Inde a adopté son drapeau en 1947. Le safran représente le courage, le blanc la paix et le vert la foi et la fertilité. Au centre figure le Chakra d’Ashoka bleu, une roue à 24 rayons symbolisant le mouvement éternel et le dharma. Par la loi, le drapeau doit être tissé en coton khadi filé à la main.',
  },
  yemen: {
    ...
    fr: 'Le Yémen a adopté son drapeau en 1990, après l’union du Nord et du Sud. Le rouge représente le sang des martyrs et l’unité, le blanc un avenir radieux et le noir le passé sombre sous l’oppression. C’est le plus dépouillé des drapeaux arabes de libération, sans emblème ni étoile.',
  },
  japan: {
    ...
    fr: 'Le drapeau du Japon a été consacré par la loi en 1999, bien que le disque rouge sur fond blanc, le Hinomaru, symbolise le pays depuis des siècles. Le cercle représente le soleil et la déesse Amaterasu, dont la lignée impériale descendrait, ce qui vaut au Japon son nom de Pays du Soleil levant.',
  },
  bangladesh: {
    ...
    fr: 'Le Bangladesh a adopté son drapeau en 1972, après sa guerre d’indépendance. Le champ vert représente les terres fertiles et la jeunesse de la nation, et le disque rouge le soleil levant sur un pays nouveau ainsi que le sang des morts pour la liberté. Le disque est légèrement décentré pour paraître au milieu quand le drapeau flotte.',
  },
  germany: {
    ...
    fr: 'Le drapeau actuel de l’Allemagne a été adopté en 1949. Le noir, le rouge et l’or remontent aux uniformes des volontaires ayant combattu Napoléon et sont devenus un symbole d’unité et de liberté dès la révolution de 1848. Ils représentent aujourd’hui une Allemagne démocratique et réunifiée.',
  },
  france: {
    ...
    fr: 'Le célèbre tricolore français est né de la Révolution de 1789 et a été fixé dans sa forme actuelle en 1794. Le bleu et le rouge sont les couleurs de Paris, le blanc celle de la monarchie ; ensemble, ils incarnent Liberté, Égalité, Fraternité. Il a inspiré les drapeaux de dizaines de nations.',
  },
  italy: {
    ...
    fr: 'L’Italie a adopté son drapeau en 1946, à la naissance de la république. Le vert représente l’espoir et les plaines du pays, le blanc les neiges des Alpes et la foi, et le rouge l’amour et le sang des patriotes. Le tricolore est apparu dès 1797, inspiré de la France napoléonienne.',
  },
  ireland: {
    ...
    fr: 'L’Irlande a adopté son drapeau en 1922, à la fondation de l’État libre. Le vert représente la tradition catholique et gaélique, l’orange les protestants fidèles à Guillaume d’Orange, et le blanc entre les deux l’espoir d’une paix durable entre les deux communautés.',
  },
  belgium: {
    ...
    fr: 'La Belgique a adopté son drapeau en 1831, après sa révolution contre les Pays-Bas. Le noir, le jaune et le rouge proviennent des armoiries du Brabant : un lion d’or aux griffes rouges sur champ noir. C’est l’un des rares drapeaux nationaux d’Europe à bandes verticales.',
  },
  netherlands: {
    ...
    fr: 'Les Pays-Bas ont fixé leur drapeau par décret en 1937, bien qu’il remonte à la révolte du XVIe siècle contre l’Espagne. Le rouge, le blanc et le bleu ont remplacé une bande orange antérieure. Il est considéré comme le plus ancien tricolore et a inspiré celui de la Russie et bien d’autres.',
  },
  palau: {
    ...
    fr: 'Les Palaos ont adopté leur drapeau en 1981. Le champ bleu ciel représente l’océan qui entoure les îles, et le disque doré la pleine lune, considérée comme le moment idéal pour pêcher, planter et célébrer. Le disque est légèrement décalé vers la hampe pour paraître centré au vent.',
  },
  nauru: {
    ...
    fr: 'Nauru a adopté son drapeau en 1968, le jour de son indépendance. Le champ bleu représente l’océan Pacifique, la bande jaune l’équateur, et l’étoile blanche à douze branches située juste en dessous marque la position de l’île au sud de cette ligne ainsi que ses douze tribus d’origine.',
  },
  australia: {
    ...
    fr: 'L’Australie a adopté son drapeau en 1901, peu après la fédération. L’Union Jack dans le coin reflète son histoire, la grande étoile à sept branches du Commonwealth représente les États et territoires, et les cinq étoiles de droite forment la constellation de la Croix du Sud.',
  },
  fiji: {
    ...
    fr: 'Les Fidji ont adopté leur drapeau en 1970, lors de leur indépendance. Le champ bleu clair représente l’océan Pacifique, l’Union Jack leurs liens avec la Grande-Bretagne, et l’écusson la canne à sucre, les noix de coco, les bananes et une colombe de la paix. Le ton azur évoque les eaux qui entourent les îles.',
  },
  russia: {
    ...
    fr: 'Le drapeau actuel de la Russie est revenu en 1991, bien que ses origines remontent à Pierre le Grand, à la fin du XVIIe siècle. Le blanc, le bleu et le rouge s’interprètent traditionnellement comme la noblesse, la loyauté et le courage. Ce tricolore est à l’origine des couleurs panslaves de nombreuses nations.',
  },
  spain: {
    ...
    fr: 'Le drapeau actuel de l’Espagne a été adopté en 1981. Ses bandes rouge et jaune datent de 1785, quand le roi Charles III les choisit pour que sa marine se distingue en mer. À gauche figurent les armoiries avec les Colonnes d’Hercule et la devise Plus Ultra, « Au-delà ».',
  },
  portugal: {
    ...
    fr: 'Le Portugal a adopté son drapeau en 1911, après la proclamation de la république. Le vert représente l’espoir et le rouge le sang de la révolution. Au centre se trouvent une sphère armillaire de l’ère des Découvertes et un écu dont les cinq écussons bleus rappellent les victoires sur les Maures. Ce fut le premier drapeau portugais à employer le vert.',
  },
  usa: {
    ...
    fr: 'Le drapeau américain à 50 étoiles a été adopté en 1960, après l’entrée de Hawaï dans l’Union. Les treize bandes rappellent les colonies d’origine et chaque étoile représente un État. La disposition actuelle des 50 étoiles fut conçue par un adolescent, Robert Heft, pour un devoir scolaire qui ne lui valut d’abord qu’un « B-moins ».',
  },
  uk: {
    ...
    fr: 'L’Union Jack du Royaume-Uni a pris sa forme actuelle en 1801, quand l’Irlande rejoignit l’union. Il combine les croix de saint Georges pour l’Angleterre, de saint André pour l’Écosse et de saint Patrick pour l’Irlande. Comme les croix se superposent de façon inégale, le drapeau a un bon sens et un sens inversé.',
  },
};
