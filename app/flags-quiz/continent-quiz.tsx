...
const styles = StyleSheet.create({
  ...
  // Same navy rim frame as the flag on the "All countries" screen. The flag is
  // shown with `contain` (never cropped — e.g. Uzbekistan's crescent/stars or
  // China's stars stay fully visible); the white backing fills any letterbox
  // band left by a flag whose ratio differs from the box.
  optionFrame: {
    borderWidth: 3,
