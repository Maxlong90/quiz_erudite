...
// Onboarding splash for the Flags Quiz build: a blue gradient with the QUIZZZES
// wordmark (the three middle Z's highlighted, as in the erudite brand) and the
// localized tagline — English "Train your brain!", ru «Прокачай мозг!»,
// es «¡Entrena tu mente!». Shows for 3s, then hands off to the home screen.
const SPLASH_MS = 3000;
const LETTERS = ['Q', 'U', 'I', 'Z', 'Z', 'Z', 'E', 'S'] as const;

export default function FlagsQuizSplash() {
  const t = useFQLabels();
